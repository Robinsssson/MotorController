...
#include "device/inv_mpu_dmp_motion_driver.h"
...
#    define delay_ms mirco_delay_ms
...
u8 mpu_dmp_get_data(float* pitch, float* roll, float* yaw)
{
     ...
     * This behavior is convenient because it keeps the gyro and accel outputs of dmp_read_fifo and mpu_read_fifo
     *consistent.
     **/
    /*if (sensors & INV_XYZ_GYRO )
